package com.plotpals.client.HomePage;
...
import com.plotpals.client.TemporaryHomepageActivity;
...
public class AppEntryCreateProfileActivity extends AppCompatActivity {
                ...
                (JSONObject response) -> {
                    try {
                        ...
                        if(isProfileCreatedSuccessfully) {
                            Intent temporaryHomepageIntent = new Intent(AppEntryCreateProfileActivity.this, TemporaryHomepageActivity.class);
