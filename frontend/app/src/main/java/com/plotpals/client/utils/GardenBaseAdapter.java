...
public class GardenBaseAdapter extends BaseAdapter {
    ...
    int listImages[];
    GardenDiscoverySearchActivity searchActivity;
    GoogleProfileInformation googleProfileInformation;

    public GardenBaseAdapter(Context ctx, List<Garden> garden, int[] images, GardenDiscoverySearchActivity activity, GoogleProfileInformation googleProfileInformation) {
        this.context = ctx;
...
//        gardenImg.setBackground(listImages[i]);
        ...
        view.findViewById(R.id.rectangle_4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mapsIntent = new Intent(searchActivity, GardenDiscoveryMapsActivity.class);
