...
public class GardenDiscoveryInfoNonMemberActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.join).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(GardenDiscoveryInfoNonMemberActivity.this, "Join pressed", Toast.LENGTH_SHORT).show();
                try {
