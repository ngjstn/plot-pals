...
import com.plotpals.client.GardenApplications.AdminHomepageActivity;
import com.plotpals.client.GardenApplications.GardenApplicationActivity;
...
public class AccountMainActivity extends NavBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AccountProfileActivityView.setOnClickListener(view -> {
            Intent TasksIntent = new Intent(AccountMainActivity.this, AccountProfileActivity.class);
        ...
        AccountRolesActivityView.setOnClickListener(view -> {
            Intent TasksIntent = new Intent(AccountMainActivity.this, AccountRolesActivity.class);
            googleProfileInformation.loadGoogleProfileInformationToIntent(TasksIntent);
            startActivity(TasksIntent);
        });
        ...
        findViewById(R.id.rating_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent ratingIntent = new Intent(AccountMainActivity.this, AccountRatingExplainActivity.class);
