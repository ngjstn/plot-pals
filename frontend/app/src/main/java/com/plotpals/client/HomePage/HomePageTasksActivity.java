...
public class HomePageTasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tasksListAdapter = new ArrayAdapter (HomePageTasksActivity.this, android.R.layout.simple_list_item_2, android.R.id.text1, tasksList)
        {
