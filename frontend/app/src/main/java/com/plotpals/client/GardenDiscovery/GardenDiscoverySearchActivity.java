...
public class GardenDiscoverySearchActivity extends AppCompatActivity {
...
//    ArrayList<String> gardenList = new ArrayList<String>(Arrays.asList("Garden 1", "Garden 2", "Garden 3", "Garden 4", "Garden 5"));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GardenBaseAdapter arrayAdapter = new GardenBaseAdapter(getApplicationContext(), gardenObjectList, gardenImages, GardenDiscoverySearchActivity.this, googleProfileInformation);
    ...
    private void searchGarden(String query) {
        ...
        GardenBaseAdapter arrayAdapter = new GardenBaseAdapter(getApplicationContext(), gardensSearched, gardenImages, GardenDiscoverySearchActivity.this, googleProfileInformation);
        listView.setAdapter(arrayAdapter);
    }
