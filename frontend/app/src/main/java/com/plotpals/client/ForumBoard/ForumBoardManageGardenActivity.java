...
public class ForumBoardManageGardenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        memberListAdapter = new ArrayAdapter<>(ForumBoardManageGardenActivity.this, android.R.layout.simple_list_item_1, memberNameList);
        memberListView.setAdapter(memberListAdapter);

        findViewById(R.id.arrow_back_).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ForumBoardManageGardenActivity.this, "Back Arrow pressed", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(ForumBoardManageGardenActivity.this, MyGardenYesGardenActivity.class);
        ...
        findViewById(R.id.edit_pencil).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ForumBoardManageGardenActivity.this, "edit pressed", Toast.LENGTH_SHORT).show();
                Intent editActivity = new Intent(ForumBoardManageGardenActivity.this, ForumBoardEditGardenActivity.class);
        ...
        findViewById(R.id.members_forward_arrow).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent currentMemActivity = new Intent(ForumBoardManageGardenActivity.this, ForumBoardCurrentMembersActivity.class);
