...
public class gardenBaseAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View v = inflater.inflate(R.layout.activity_garden_list_view, viewGroup, false);

        TextView gardenName = (TextView) v.findViewById(R.id.textView_garden);
        gardenName.setText(listGarden.get(i).getGardenName());

        TextView address = (TextView) v.findViewById(R.id.textView3);
...
//        gardenImg.setBackground(listImages[i]);
        ...
        v.findViewById(R.id.rectangle_4).setOnClickListener(new View.OnClickListener() {
            @Override
